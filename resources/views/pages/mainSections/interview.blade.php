...
<section class="container-fluid bg-white d-flex justify-content-center">
    <div class="accordion d-flex justify-content-center flex-wrap compressed-window-width"  id="accordionPanelsStayOpenExample">
        ...
        <div class="accordion-item col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
            ...
            <div id="panelsStayOpen-collapse1" class="accordion-collapse collapse lh-base" aria-labelledby="panelsStayOpen-heading1">
        ...
        <div class="accordion-item col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
            <h2 class="accordion-header" id="panelsStayOpen-heading2">
                <div class="accordion-button collapsed lh-base" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapse2" aria-expanded="false" aria-controls="panelsStayOpen-collapseTwo">
        ...
        <div class="accordion-item col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
            <h2 class="accordion-header" id="panelsStayOpen-heading3">
                <div class="accordion-button collapsed lh-base" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapse3" aria-expanded="false" aria-controls="panelsStayOpen-collapseThree">
            ...
            <div id="panelsStayOpen-collapse3" class="accordion-collapse collapse lh-base" aria-labelledby="panelsStayOpen-heading3">
                <div class="accordion-body text-body">
        ...
        <div class="accordion-item col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
            <h2 class="accordion-header" id="panelsStayOpen-heading4">
                <div class="accordion-button collapsed lh-base" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapse4" aria-expanded="false" aria-controls="panelsStayOpen-collapseThree">
                    Виктория: “Скажите, Иван, что делать, если площадь небольшая, а очень многое хочется туда уместить? Особенно актуален этот вопрос, на мой взгляд, для тех, кто живет на Урале, где и одежда на все сезоны, и могут быть велосипеды, доски для катания и другие сезонные вещи”                        </div>
            </h2>
        ...
        <div class="accordion-item col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
            <h2 class="accordion-header" id="panelsStayOpen-heading6">
                <div class="accordion-button collapsed lh-base" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapse6" aria-expanded="false" aria-controls="panelsStayOpen-collapseThree">
                    Виктория: “Иван, и финальный вопрос.
                    Вот вы закончили проект, порекомендовали строителей для реализации, провели авторский надзор на монтаже…А что дальше? Вы поддерживайте с клиентом дальнейший диалог? Можно ли получить советы по эксплуатации: подсказки, рекомендации?”</div>
            </h2>
        ...
        <div class="accordion-item col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
            <h2 class="accordion-header" id="panelsStayOpen-heading7">
                <div class="accordion-button collapsed lh-base" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapse7" aria-expanded="false" aria-controls="panelsStayOpen-collapseThree">
                    Виктория: “Благодарю за интервью! Я убеждена, что многие читатели нашли ответы на свои вопросы”</div>
            </h2>
