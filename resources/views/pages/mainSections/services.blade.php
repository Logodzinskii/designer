                ...
                <ul class="list-unstyled fs-5" style="margin-bottom: 40px; height: 70%">
                    ...
                    <li class="d-flex justify-content-start">
                        ...
                        — План расстановки мебели с размерами">
                            <u>Разработка планировочных решений</u>
                        </span>
                    </li>
                    <li class="d-flex justify-content-start">
                        <span style="cursor:pointer;"
            ...
            <div class="bg-info square-content " style="height: 95%">
                ...
                <ul class="list-unstyled fs-5" style="margin-bottom: 40px; height: 70%">
                    ...
                    <span style="cursor:pointer;"
                        ...
                        <u>Еженедельное посещение объекта</u>
                        </span>
                    </li>
                    <li class="d-flex justify-content-start">
                        <span style="cursor:pointer;"
                        ...
                        — Необходимое общение с прорабом на объекте и по телефону, консультации по всем предоставленным чертежам<br>">
                            <u>Надзор за начальными строительно-отделочными работами</u>
                        </span>
                    </li>
                    ...
                    <li class="d-flex justify-content-start">
                        ...
                        —  Надзор за расстановкой мебели, оборудованием и декоративных элементов<br>">
                            <u>Предоставление прибыли о выполненных работах на объекте</u>
                        </span>
                    </li>
